...
export default function GastosPage() {
    ...
    const filtered = mockGastos.filter((g) => {
        const matchSearch =
    ...
    const porCategoria = CATEGORIAS.map((cat) => ({
        ...
        count: mockGastos.filter((g) => g.categoria === cat).length,
    })).filter((c) => c.count > 0)
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-l-4 border-l-primary sm:col-span-2 lg:col-span-1">
                        <CardContent className="p-4">
                            ...
                            <p className="text-[11px] text-muted-foreground mt-1">{mockGastos.length} registros</p>
                        </CardContent>
                    </Card>
                    ...
                    <CardHeader className="py-3 px-5">
                        <div className="flex items-center justify-between gap-4">
                            <CardTitle className="text-sm font-medium text-muted-foreground">
                                ...
                                {filtered.length !== mockGastos.length && ` filtrados de ${mockGastos.length}`}
                                {" — Total: "}{formatMXN(filtered.reduce((s, g) => s + g.monto, 0))}
                            </CardTitle>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <Badge variant="secondary" className="text-[10px] mt-1">
                                            {mockGastos.find(g => g.gasto_id === detail.gasto_id)
